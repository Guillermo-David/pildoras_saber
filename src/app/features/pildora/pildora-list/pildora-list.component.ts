...
export class PildoraListComponent {
    ...
    this.pildoraService.getPildoras(paginaActual, tamanoPagina, this.currentSortField, this.currentSortOrder, this.activeFilters).subscribe({
      next: (resultados) => {
        ...
        if (this.paginator) {
          ...
          this.paginator.pageIndex = resultados.pageNumber;
          this.paginator.pageSize = resultados.pageSize;
  ...
  onSort(event: any) {
    ...
    if (event.sortField && event.sortOrder && (event.sortField !== this.currentSortField || sortOrderString !== this.currentSortOrder)) {
      ...
      this.paging.pageNumber = 0;
      // this.getPildoras(this.paging.pageNumber, this.paging.pageSize);
      this.actualizarDatos();
    }
  }
  ...
  ngAfterViewInit() {
    ...
    this.paginator.page.subscribe(() => {
      this.paging.pageNumber = this.paginator.pageIndex;
